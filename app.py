...
def chart_expense_distribution(categories):
    ...
    colors = ['#79BBC3','#00CEC9','#FD79A8','#FDCB6E','#55EFC4',
...
def chart_monthly_trend(monthly_spending):
    ...
    fig, ax = plt.subplots(figsize=(7, 3.8))
    fig.patch.set_alpha(0)
    ax.fill_between(months, values, alpha=0.12, color='#79BBC3', zorder=1)
    ax.plot(months, values, color='#79BBC3', linewidth=2.5, marker='o',
            markersize=7, markerfacecolor='white', markeredgecolor='#79BBC3',
            markeredgewidth=2, zorder=2)
    for i, (m, v) in enumerate(zip(months, values)):
        ax.text(i, v + max(values) * 0.03, f'₹{v:,.0f}',
                ha='center', va='bottom', fontsize=8, color='#79BBC3', fontweight='bold')
...
def chart_category_breakdown(categories):
    ...
    colors = ['#79BBC3','#0984E3','#00CEC9','#00b894','#55EFC4',
